...
const getPendingCompanySurvey = async (req, res) => {
    try {
        ...
        res.status(500).json({
            success: false,
            message: "Internal server error in getPendinCompanySUrvey method"
        });
    }
};
...
module.exports = { getAllCompanies, getPendingCompanySurvey, getSurveyIntroDetails, startSurvey, givenSurvey }
